...
struct DashboardView: View {
            ...
            ToolbarItem(placement: .topBarTrailing) {
                NavigationLink {
                    ...
                    Image(systemName: "bell.badge.fill")
                        ...
                        .foregroundStyle(.red, Color(red: 0.10, green: 0.38, blue: 0.73))
                }
            }
        }
        .refreshable {
    ...
    private func refreshAll() async {
        ...
        // Fetch wallet balance and active session concurrently
